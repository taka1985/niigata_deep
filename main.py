from train_algorism.train import train
...
#
# # np.savetxt("estimate",y_estim,delimiter=',',fmt = '%s')
# # np.savetxt("real",t_test,delimiter=',',fmt = '%s')
#
# path = "result"
# np.savetxt(os.path.join(path,"d{0}.csv".format(filenum)),testday,delimiter=',',fmt='%s')
# np.savetxt(os.path.join(path,"r{0}.csv".format(filenum)),t_test,delimiter=',',fmt='%s')
# np.savetxt(os.path.join(path,"e{0}.csv".format(filenum)),y_estim,delimiter=',',fmt='%s')
# print(test_loss)
